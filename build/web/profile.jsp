        ...
        <h1>Profile PAGE</h1>
            ...
            <%
                ...
                if (request.getMethod().equals("POST")){
                    ...
                    DBManager.updateUser(originalEmail,fname,lname,email,password,street,postCode,city,state,country);

                    DBManager.addAccessLogEntry(email, fname, "Update Details"); 
               }
            %>
