...
public class EditShipment extends HttpServlet {
    ...
    try {
        if (!validator.validateStringPattern(street)) {
            ...
            manager.updateShipment(shipmentID, street, postCode, city, country, method, state);
            shipment = new Shipment(shipmentID, street, postCode, country, city, method, orderID, state);
